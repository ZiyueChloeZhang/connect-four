            ...
            <div className='menu-container' id='rule-dialog'>
                <Dialog.Panel>
                    <div>
                        ...
                        <section>
                            <h2>OBJECTIVES</h2>
                            <p>Be the first player to connect 4 of the same colored discs in a row (either vertically,
                    ...
                    <img role="button" src={checkIcon} alt="check icon" onClick={closeDialog}/>
                </Dialog.Panel>
            </div>
        </Dialog>
    )
